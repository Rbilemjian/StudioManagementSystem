                    ...
                    <div class="card-body">
                        <form @submit.prevent="authenticate">
                            ...
                            <div class="form-group-row text-center" style="margin-top:20px;">
                                <input type="submit" id="login-submit" class="btn btn-primary btn-md"><span style="padding-left: 7px" class="glyphicon glyphicon-login" aria-hidden="true"></span></button>
                            </div>
